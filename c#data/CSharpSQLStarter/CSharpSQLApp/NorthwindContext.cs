...
{
    public class NorthwindContext : DbContext //context is setting up the relationship
    {
        ...
        public NorthwindContext(DbContextOptions<NorthwindContext> options)
            : base(options)
        { }
        public virtual DbSet<Customer> Customers { get; set; } //still a collection but DbSet belongs to Entity
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        {
            //mapping all the models of the database
