...
namespace lab_47_asp_core_mvc.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StudentId,StudentName,DateOfBirth,CurrentlyStudent,CollegeId")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentId,StudentName,DateOfBirth,CurrentlyStudent,CollegeId")] Student student)
        {
